...
- In the pop-up window, enter a title for your index, choose `Search Bar` as the type, and click “Create” to proceed.
![Create index](images/index/search_bar/create_index.png)
...
![Index overview](images/index/search_bar/index_overview.png)

#### Step 4: Add a Data Source

- Click on "Data sources" tab and you will be taken to the data source page.
![Data sources](images/index/search_bar/index_data_source.png)
...
![Web data sources](images/index/search_bar/index_web_data_source.png)
...
![Add web data sources](images/index/search_bar/index_add_web_data_source.png)
- You will be taken back to the previous page with the newly created data source listed under the "Web data sources" section.
![Updated web data sources](images/index/search_bar/updated_web_data_source.png)
...
![API data sources](images/index/search_bar/index_api_data_source.png)
...
![API data sources](images/index/search_bar/create_api_data_source.png)
- Once configured, Data health check on your api will be performed.
![API data sources](images/index/search_bar/api_data_source_health_check.png)
    ...
    ![API data sources](images/index/search_bar/api_data_source_required_info_missing.png)

- Click on "Add data source" in the confirmation pop-up window.
![API data sources](images/index/search_bar/api_data_source_confirm.png)
- You will be taken back to the previous page with the newly created data source listed under the "API data sources" section.
![Updated API data sources](images/index/search_bar/updated_api_data_source.png)
...
![Push API data sources](images/index/search_bar/push_api_data_source_toggle.png)
...
![Push API data sources](images/index/search_bar/push_api_data_source_error_report.png)
...
![Index overview](images/index/search_bar/index_overview_pending_sync.png)
...
2. Request Synonyms setup for your Index
    ...
    ![Synonyms](images/index/search_bar/index_synonyms.png)
...
1. Access Featured Results
    ...
    ![Featured results](images/index/search_bar/index_featured_results.png)
...
2. Create Featured Results
    ...
    - Enter details such as:
        ...
        ![Add featured results](images/index/search_bar/index_add_featured_results.png)
3. Save and Verify
    ...
    ![Set up featured results](images/index/search_bar/index_setup_featured_results.png)
...
![Delete index](images/index/search_bar/index_overview_delete.png)

2. Click on "Delete" in the pop-up window.
![Delete index](images/index/search_bar/delete_index.png)

3. You will be brought back to the index library page after the index is successfully removed.
![Delete index](images/index/search_bar/index_deleted.png)
