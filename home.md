...
2. [Onboarding Guide](onboarding)  
   2.1 [Onboarding for Search Bar](onboarding-searchbar#onboarding-for-search-bar)  
...
6. [Index Guide](index#index)  
   6.1 [Search Index](index-searchbar)  
   6.2 [SmartRecommend Index](index-smartrecommend)  
7. [Application Guide](application#application)  
   ...
   7.2 [Search Bar](application-searchbar#search-bar)  
      - [How to create a Search Bar?](application-searchbar#how-to-create-a-search-bar)  
