...
2. [Onboarding Guide](onboarding)  
   2.1 [Onboarding for Website Search](onboarding-searchbar#onboarding-for-website-search)  
   2.2 [Onboarding for SmartRecommend](onboarding-smartrecommend#onboarding-for-smartrecommend)  
3. [Authentication Guide](authentication#authentication)  
   ...
   3.3 [How to sign out of the Admin Portal?](authentication#how-to-sign-out-of-the-admin-portal)  
...
6. [Index Guide](index#index)  
   6.1 [Public Web Index](index-publicweb)  
   6.2 [Recommendation Index](index-recommendation)  
7. [Application Guide](application#application)  
   ...
   7.2 [Website Search](application-searchbar#website-search)  
      - [How to create a Website Search Bar?](application-searchbar#how-to-create-a-website-search-bar)  
      - [Configuring your Website Search Bar](application-searchbar#configuring-your-website-search-bar)  
      - [How to disable a Website Search Bar?](application-searchbar#how-to-disable-a-website-search-bar)  
      - [How to enable a Website Search Bar?](application-searchbar#how-to-enable-a-website-search-bar)  

   7.3 [SmartAnswer](application-smartanswer#smartanswer)  
   7.4 [SmartRecommend](application-smartrecommend#smartrecommend)  
      - [How to create a Rule-based recommendation banner?](application-smartrecommend#how-to-create-a-rule-based-recommendation-banner)  
      - [How to create a ML-based recommendation banner?](application-smartrecommend#how-to-create-a-ml-based-recommendation-banner)  
      - [Banner Placement Rules](application-smartrecommend#banner-placement-rules)  
      - [How to delete SmartRecommend banner?](application-smartrecommend#how-to-delete-smartrecommend-banner)  
      - [How to disable SmartRecommend banner?](application-smartrecommend#how-to-disable-smartrecommend-banner)  
      - [How to enable SmartRecommend banner?](application-smartrecommend#how-to-enable-smartrecommend-banner)  
      - [How to duplicate SmartRecommend banner?](application-smartrecommend#how-to-duplicate-smartrecommend-banner)  

8. [Analytics Guide](analytics#search-bar-analytics)  
