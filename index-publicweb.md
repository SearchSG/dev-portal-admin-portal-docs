...
- **Status Definitions**:
    - `Action required: Add data source`: This status means at least **one data source** must be added before the public web index can start supporting search functionality.
    - `Pending sync`: This status indicates the public web index is queued for syncing and waiting to start.
    - `Syncing`: This status indicates that data syncing is currently in progress. Please wait for it to complete.
    - `Active`: This status indicates that the public web index is now active and serving search results.

#### Step 4: Add a Data Source

- Click "Data Sources" tab and you will be redirected to the data sources page.
![Data sources](images/index/public_web/index_data_sources.png)
...
![Add web data sources](images/index/public_web/add_web_data_source.png)
...
![Add web data sources confirmation](images/index/public_web/add_web_data_source_confirmation.png)
...
![Added web data sources](images/index/public_web/added_web_data_source.png)
...
![API data sources](images/index/public_web/api_data_source.png)
...
![Add API data sources](images/index/public_web/add_api_data_source.png)
- Once configured, a data health check will be performed on your API.
![API data sources health check pass](images/index/public_web/api_data_source_health_check_pass.png)
    ...
    ![API data sources health check fail](images/index/public_web/api_data_source_health_check_fail.png)

- Click "Add data source" in the confirmation pop-up.
![Add API data sources confirmation](images/index/public_web/add_api_data_source_confirmation.png)
...
![Added API data sources](images/index/public_web/added_api_data_source.png)
...
![Enable Push API data sources](images/index/public_web/push_api_data_source_toggle.png)
...
![Push API data sources error report](images/index/public_web/push_api_data_source_error_report.png)
...
![Index overview pending sync](images/index/public_web/index_overview_pending_sync.png)
...
2. Request Synonyms setup for your Index
    ...
    ![Synonyms](images/index/public_web/synonyms.png)
...
1. Access Featured Results
    ...
    ![Featured results](images/index/public_web/featured_results.png)
...
2. Create Featured Results
    ...
    - Enter the following details:
        ...
        ![Add featured results](images/index/public_web/add_featured_results.png)
3. Save and Verify
    ...
    ![Added featured results](images/index/public_web/added_featured_results.png)

### How to Delete the Search Index?

***Note: Deleting a search index will permanently remove all previously collected interaction feedback and incremental learning data associated with it, which may negatively impact search relevance.***
...
![Delete index confirmation](images/index/public_web/delete_index_confirmation.png)

3. You will be redirected to the index library page once the index is successfully removed.
![Deleted index](images/index/public_web/deleted_index.png)
